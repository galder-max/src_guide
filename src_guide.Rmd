...
segments. Then we plot the genome-wide profile.
...
In this very similar solution, we can see two very closeby clusters, which, if they
were real, would need to be linear due to the pigeonhole
principle (see Lexicon in main text). 
...
to the SRC and we tend to merge them with the closest and larger
...
segments. The clustering contingency table looks relatively good, but
